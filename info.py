...
STREAM_SITE = (environ.get('STREAM_SITE', 'sharelinks.in'))
STREAM_API = (environ.get('STREAM_API', '8709f8b09c3f169265a6935c4587498c745125d8'))
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/Movies_island8/235'))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5010934394').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001730540985').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5010934394').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5010934394').split()]
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ʀᴀᴊʙʜᴀʀ ꜱᴀʜᴇʙ')
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001930913574'))
